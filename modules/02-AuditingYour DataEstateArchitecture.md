...
<h4>Scenario: Wide World Importers</h4>
...
- The database team at WideWorldImporters wants to evaluate SQL Server on Linux
...
- WideWorldImporters is also evaluating Azure SQL so they want to know what features in SQL Server also work in the Microsoft Azure Data Platform
...
<h4>Working with a Business Analyst</h4>
...
<p><img style="float: left; margin: 0px 15px 15px 0px;" src="https://github.com/microsoft/sqlworkshops/blob/master/graphics/point1.png?raw=true"><b>Activity: Detail your Organization's Data Estate Goals</b></p>
<br>
...
<h4>Data Movement options</h4>
There are multiple options your organization likely has to move data from one location to another. They are grouped into two general toolsets: a manual, scripted, or platform-specific tool (such as PowerShell or SQL Server Integration Services) and a system specifically designed to move and potentially operate on data, called a <i>Pipeline</i>.

The process to locate these processes and tools are to engage with the team that is responsible for creating and running them. You can often find those systems when you look at your Reporting and Business Intelligence outputs.
