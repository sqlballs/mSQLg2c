...
<p><img style="float: left; margin: 0px 15px 15px 0px;" src="https://github.com/microsoft/sqlworkshops/blob/master/graphics/point1.png?raw=true"><b>Activity: Learn about the Cyber Kill Chain</b></p>
...
Click on this <a href="https://learn.microsoft.com/en-us/training/modules/azure-security-center/2-cyber-kill-chain">link</a> and read Unit 2 of the Ennable and manage Microsoft Defender for Cloud MS Learn Module, Review the cyber kill chain 
<p>
<p style="border-bottom: 1px solid lightgrey;"></p>
